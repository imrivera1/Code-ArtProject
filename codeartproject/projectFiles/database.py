...
from login import login_manager, login_blueprint, AdminModelViewAcc, AdminModelViewIntern, AdminModelViewEvent,  AdminModelViewLogout
...
admin.add_link(MenuLink(name="Logout", category='', url=url_for('logout.html')))
